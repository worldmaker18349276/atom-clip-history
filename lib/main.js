...
module.exports = {
  activate() {
    ...
    this.disposables.add(atom.workspace.onDidChangeActiveTextEditor(() => this.history.resetPasteState()))

    this.atomClipboardWrite = atom.clipboard.write
    atom.clipboard.write = (...args) => {
      this.history.copy(...args)
    ...
    this.disposables.add(atom.commands.add("atom-text-editor", {
      "clip-history:paste": function() { paste(this.getModel(), PASTE.OLDER) },
      "clip-history:paste-newer": function() { paste(this.getModel(), PASTE.NEWER) },
      "clip-history:paste-last": function() { paste(this.getModel(), PASTE.LAST) },
